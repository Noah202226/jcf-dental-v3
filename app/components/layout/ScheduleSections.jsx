          ...
          return (
            <button
              ...
              className={`aspect-square rounded-xl flex flex-col items-center justify-center relative transition-all text-xs font-semibold
                ...
                ${isSelected ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/20" : "hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400"}
      ...
      <main className="max-w-9xl mx-auto p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="lg:col-span-4 space-y-6">
          ...
          <button
            ...
            className="w-full py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 shadow-xl shadow-emerald-500/10 transition-transform active:scale-95"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  onClick={handleSave}
                  disabled={isSaving}
                  className="flex-[2] py-3 bg-emerald-500 text-white rounded-xl font-bold uppercase tracking-widest text-xs shadow-lg shadow-emerald-500/20"
                >
