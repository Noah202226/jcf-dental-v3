  ...
  return (
    <>
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-0 sm:p-4 bg-zinc-950/40 backdrop-blur-md animate-in fade-in duration-300">
        <div className="bg-white dark:bg-zinc-950 w-full h-full sm:h-[90vh] sm:max-w-9xl sm:rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col border border-white/20 dark:border-zinc-800">
          {/* Header Area */}
