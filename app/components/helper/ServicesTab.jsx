    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 dark:hover:bg-emerald-400 text-white font-black px-6 py-3.5 rounded-2xl shadow-lg shadow-emerald-500/20 transition-all active:scale-95 text-sm uppercase tracking-tight"
        >
            ...
            <form onSubmit={handleAdd} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all font-black text-lg text-emerald-600"
                  placeholder="0.00"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 dark:hover:bg-emerald-400 text-white font-black py-4 rounded-2xl shadow-xl shadow-emerald-500/20 transition-all active:scale-[0.98] uppercase tracking-widest text-xs"
              >
                Register Service
              </button>
            </form>
